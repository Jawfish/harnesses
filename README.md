...
| [Qwen Code](https://github.com/QwenLM/qwen-code)          | Apache-2.0    | [![Stars](https://img.shields.io/github/stars/QwenLM/qwen-code?style=flat-square&label=%E2%98%85)](https://github.com/QwenLM/qwen-code/stargazers)                   | TypeScript |     ✓      |       ✓        |   ✓   |   ✓   |    ✓    |   ✓    |   ✓   |    ✓     |     ✓     | QWEN.md ⁷        |
| [Aider](https://github.com/Aider-AI/aider)                | Apache-2.0    | [![Stars](https://img.shields.io/github/stars/Aider-AI/aider?style=flat-square&label=%E2%98%85)](https://github.com/Aider-AI/aider/stargazers)                       | Python     |     ✓      |       ✓        |   ✗   |   ✗   |    ✗    |   ✗    |   ✓   |    ✓     |     ✗     | CONVENTIONS.md ⁵ |
| [goose](https://github.com/aaif-goose/goose)              | Apache-2.0    | [![Stars](https://img.shields.io/github/stars/aaif-goose/goose?style=flat-square&label=%E2%98%85)](https://github.com/aaif-goose/goose/stargazers)                   | Rust       |     ✓      |       ✓        |   ✓   |   ✗   |    ✓    |   ✓    |   ✓   |    ✓     |     ✓     | AGENTS.md ⁶      |
...
⁵ Aider can load arbitrary read-only instruction files; CONVENTIONS.md is the documented convention example.  
⁶ goose also reads .goosehints and recipe instructions.
⁷ Qwen Code also supports .qwen/rules and .qwen/skills.
